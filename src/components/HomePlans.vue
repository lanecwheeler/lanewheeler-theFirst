                    ...
                    <v-card>
                        ...
                        <v-card-actions v-if="['menu'].includes($route.name)">
                            <v-btn
                                ...
                                block
                                color="green"
                                @click="showRecipes(item.planName)"
    ...
    data() {
        return {
            items: [
                {
                    planName: 'Keto',
                    imgSrc: 'http://source.unsplash.com/hjCA3ecCXAQ',
                    description:
                ...
                {
                    planName: 'Paleo',
                    imgSrc: 'http://source.unsplash.com/6S27S6pZ6o0',
                    description:
                ...
                {
                    planName: 'Vegan',
                    imgSrc: 'http://source.unsplash.com/1SPu0KT-Ejg',
                    description:
